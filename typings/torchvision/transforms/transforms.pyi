...
class Compose(Generic[T_co]):
    ...
    """
    def __init__(self, transforms: list[Callable[[Image], Any]]) -> None: ...
    def __call__(self, img: Image | Tensor | np.ndarray[Any, Any]) -> T_co: ...
...
class ToTensor:
    ...
    def __call__(self, pic: Image | np.ndarray[Any, Any]) -> Tensor:
        """
        Args:
...
class PILToTensor:
    ...
    """
    def __init__(self) -> None: ...
    def __call__(self, pic: Image) -> Tensor:
        """
        .. note::
...
class Resize(torch.nn.Module):
    ...
    def __call__(self, img: Image | Tensor) -> Image | Tensor: ...
    def forward(self, img: Image | Tensor) -> Image | Tensor:
        """
        Args:
