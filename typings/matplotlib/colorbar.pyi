...
class Colorbar:
    ...
    def __init__(self, ax, mappable: Incomplete | None = None, *, cmap: Incomplete | None = None, norm: Incomplete | None = None, alpha: Incomplete | None = None, values: Incomplete | None = None, boundaries: Incomplete | None = None, orientation: Incomplete | None = None, ticklocation: str = 'auto', extend: Incomplete | None = None, spacing: str = 'uniform', ticks: Incomplete | None = None, format: Incomplete | None = None, drawedges: bool = False, extendfrac: Incomplete | None = None, extendrect: bool = False, label: str = '', location: Incomplete | None = None) -> None: ...
    @property
    def locator(self): ...
    @locator.setter
