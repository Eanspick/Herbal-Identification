...
MarkEveryType = None | int | tuple[int, int] | slice | list[int] | float | tuple[float, float] | list[bool]
MarkerType = str | path.Path | MarkerStyle
FillStyleType: Incomplete
JoinStyleType: Incomplete
CapStyleType: Incomplete
RcStyleType = str | dict[str, Any] | pathlib.Path | Sequence[str | pathlib.Path | dict[str, Any]]
